 ...
 * ```
 */
export async function render(scene, options) {
 ...
 */
export async function renderGif(scene, output, options) {
 ...
 * @returns The output file path.
 */
export async function renderMp4(scene, output, options) {
 ...
 * @returns The output file path.
 */
export async function renderWebm(scene, output, options) {
 ...
 * ```
 */
export function exportJson(scene, outputPath) {
